...
particlesJS("particles-js", {
  particles: {
    number: {
      value: 25, // Número de partículas (corazones)
      density: {
        enable: true,
        value_area: 800,
      },
    ...
    shape: {
      type: "image",
      image: {
        src: "https://static.vecteezy.com/system/resources/previews/001/187/438/original/heart-png.png", // Aquí puedes usar cualquier imagen de corazón
        width: 2,
        height: 2,
      },
    },
...
const mensajes = [
    ...
    "Mi Amor Bonito. 💓",
    "Bonito es verte sonreir 😊",
    "Bonito es hablar contifo cada día. 🌹",
    "Bonito es escuchar tu voz. 💖",
    "Bonito es mirarte a los ojos. 👀",
    "Bonito es poder besarte. 💓",
    "Bonito es saber que tú estás en mi vida. 💖",
    "No quiero a otra persona, solo a tí. 💖"
];
